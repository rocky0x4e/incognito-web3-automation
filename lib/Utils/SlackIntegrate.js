...
const run = async() => {
    ...
    let response = await callApi('#web3_automation_report', 'mocha', listAccount.botSlackAuthen, blocks)
...
const initLinkBlock = async() => {
    return linkBlock = {
        ...
        "text": {
            "type": "mrkdwn",
            "text": "*Link* : file:///Users/autonomous/Desktop/workspace/nodejs/incognito-web3-automation/mochawesome-report/mochawesome.html"
        }
    }
};
