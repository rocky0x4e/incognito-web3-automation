...
class CliAction extends BaseAction {
    ...
    async trade(selToken, buyToken, sellAmount, tradingFee, minAcceptAmount, tradingPath, prvFee) {
        return await this.node.cli.trade(this.keyInfo.PrivateKey, selToken, buyToken, sellAmount, tradingFee, minAcceptAmount, tradingPath, prvFee);
    }
...
class SdkAction extends BaseAction {
    ...
    async swap({ tokenSell, tokenBuy, amount, tradePath, tradingFee, feeToken, minAcceptableAmount, version = 2, networkFee = 100, memo = "" }) {
    ...
    async addOrder({ poolPairID, tokenIDToSell, tokenIDToBuy, sellAmount, buyAmount, version = 2, networkFee = 100, info = "" }) {
    ...
    async cancelOrder({ token1ID, token2ID, poolPairID, orderID, amount = "0", txType = 0, nftID, version = 2, networkFee = 100, info = "" }) {
