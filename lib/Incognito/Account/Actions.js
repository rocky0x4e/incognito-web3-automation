...
class SdkAction extends BaseAction {
    ...
    async init({
        coinService = ENV.Testbed.CoinService.url,
        fullNode = ENV.Testbed.FullNode.url,
        pubsubService = ENV.Testbed.PubsubService.url,
        requestService = ENV.Testbed.WebService.url,
        apiService = ENV.Testbed.Backend.url
    } = {}) {
