...
class SdkAction extends BaseAction {
    ...
    async init({ coinService = ENV.CoinService.url, fullNode = ENV.FullNode.url, pubsubService = ENV.PubsubService.url,
        requestService = ENV.WebService.url, apiService = ENV.Backend.url } = {}) {
